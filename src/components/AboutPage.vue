<template>
  <div class="info-page">
    <section class="info-section">
      <h2 class="info-heading">What is Brainrot Info?</h2>
    ...
    <section class="info-section">
      <h2 class="info-heading">Copyright & Disclaimer</h2>
    ...
    <section class="info-section">
      <h2 class="info-heading">Data & Accuracy</h2>
    ...
    <section class="info-section">
      <h2 class="info-heading">Eternal Machine Disclaimer</h2>
    ...
    <section class="info-section">
      <h2 class="info-heading">Bugs & Contributions</h2>
    ...
    <p class="info-copy">&copy; {{ new Date().getFullYear() }} Brainrot Info &mdash; Unofficial fan site.</p>
  </div>
</template>
